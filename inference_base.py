...
def parse_args():
    parser = argparse.ArgumentParser(description="Run inference on original LLaMA model for comparison")
...
def format_prompt(question):
    """Format the prompt similar to the training data format for fair comparison"""
...
def main():
    ...
    # Run in interactive mode
        ...
        print("=" * 50)
        print("Interactive mode (BASE MODEL). Type 'exit' to quit.")
        print("=" * 50)
